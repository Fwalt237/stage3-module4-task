...
public class TagModelAssembler {
    ...
    public EntityModel<TagDtoResponse> toModel(TagDtoResponse tagDtoResponse, Long id){
    ...
    public PagedModel<EntityModel<TagDtoResponse>> toPagedModel(
            Page<TagDtoResponse> page,
            String searchName,
            Pageable pageable){
